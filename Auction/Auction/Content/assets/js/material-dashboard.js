...
function darkMode(el) {
  ...
  let text_span = document.querySelectorAll('span.text-dark, .breadcrumb .text-dark');
  let text_span_white = document.querySelectorAll('span.text-white, .breadcrumb .text-white');
  ...
  let text_nav_link_white = document.querySelectorAll('a.nav-link.text-white');
  ...
  let btn_text_dark = document.querySelectorAll('.btn.btn-link.text-dark, .material-icons.text-dark');
  let btn_text_white = document.querySelectorAll('.btn.btn-link.text-white, .material-icons.text-white');
